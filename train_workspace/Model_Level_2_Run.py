...
model = level_model_soft(df_train_x,df_train_emb_x,"Level_Paralogs_Softmax")

reset_weights(model)

log = fit_model_level_soft(df_train_x,df_train_emb_x,df_train_y,df_val_x,df_val_emb_x,df_val_y,model,nr_epochs,Adamax(),256,[0.2,1],0)
