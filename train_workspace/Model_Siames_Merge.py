...
model = level_siames_merge_layer(df_train_x,df_train_emb_x_1,df_train_emb_x_2,"Siames_Binary",128)

reset_weights(model)

log = fit_model_siames(df_train_x.values,df_train_emb_x_1.values,df_train_emb_x_2.values,df_train_y.values,df_val_x.values,df_val_emb_x_1.values,df_val_emb_x_2.values,df_val_y.values,model,1500,Adamax(),256,[1,0.2],0)
...
model = level_siames_merge_layer_soft(df_train_x,df_train_emb_x_1,df_train_emb_x_2,"Siames_Softmax",128)

reset_weights(model)

log = fit_model_siames_soft(df_train_x.values,df_train_emb_x_1.values,df_train_emb_x_2.values,df_train_y.values,df_val_x.values,df_val_emb_x_1.values,df_val_emb_x_2.values,df_val_y.values,model,1500,Adamax(),256,[1,0.2],0)
