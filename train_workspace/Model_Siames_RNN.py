...
def level_siames_merge_RNN_layer_soft(df_meta_input,df_embeddings_1,df_embeddings_2,name,bs):    
...
model = level_siames_merge_RNN_layer_soft(df_train_x,df_train_emb_x_1,df_train_emb_x_2,"Siames_Paralogs_RNN_Softmax",128)

log = fit_model_siames_soft(df_train_x.values,df_train_emb_x_1.values.reshape(df_train_emb_x_1.shape[0],df_train_emb_x_1.shape[1],1),df_train_emb_x_2.values.reshape(df_train_emb_x_2.shape[0],df_train_emb_x_2.shape[1],1),df_train_y.values,df_val_x.values,df_val_emb_x_1.values.reshape(df_val_emb_x_1.shape[0],df_val_emb_x_1.shape[1],1),df_val_emb_x_2.values.reshape(df_val_emb_x_2.shape[0],df_val_emb_x_2.shape[1],1),df_val_y.values,model,150,Adamax(),128,[1,0.3],2)
